...
<img src="assets/banner.svg" alt="BNUUYCODE. Java, Python, SQLite">
...
<img alt="languages by bytes committed" src="assets/languages.svg">
...
<div align="center">
<sub>the header and the language card are SVGs, built by <a href="assets/build-banner.sh"><code>build-banner.sh</code></a> and <a href="assets/build-languages.sh"><code>build-languages.sh</code></a>.</sub>
<br>
<sub>the bnuuy in it is emote geometry from <a href="https://github.com/bnuuyCode/chiwavisualkit">chiwavisualkit</a>, coordinate for coordinate. Nothing redrawn.</sub>
</div>
